...
enum class AVSProfiles(val value: Int) {
    ...
    companion object {
        fun from(findValue: Int): String? = AVSProfiles.values().find { it.value == findValue }?.name
    }
...
enum class AVSLevels (val value: Int) {
    ...
    companion object {
        fun from(findValue: Int): String? = AVSLevels.values().find { it.value == findValue }?.name
    }
}