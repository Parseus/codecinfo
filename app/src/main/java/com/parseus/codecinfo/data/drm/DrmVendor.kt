...
enum class DrmVendor(val uuid: UUID) {
    ...
    AdobePrimeTime(UUID(-992507800680445872L, -7199381120623628549L)) {
        override fun getVendorStringProperties(): Map<Int, String>? = null
        override fun getVendorByteArrayProperties(): Map<Int, String>? = null
    },
    ...
    VeraMatrix(UUID(-7338653513101981915L, -8305690818819724279L)) {
        override fun getVendorStringProperties(): Map<Int, String>? = null
        override fun getVendorByteArrayProperties(): Map<Int, String>? = null
    },
    ...
    abstract fun getVendorStringProperties(): Map<Int, String>?
    abstract fun getVendorByteArrayProperties(): Map<Int, String>?

    companion object {
        fun getFromUuid(uuid: UUID) = values().first { uuid == it.uuid }
