...
enum class DrmVendor(val uuid: UUID,
    ...
    // List the most common vendors first so they can be found faster, especially on Android 11+.
    ...
    // Those vendors are very uncommon on Android devices,
    // but they're still here for the sake of completeness.
    ...
    companion object {
        ...
        val WIDEVINE_STRING_PROPERTIES = mapOf(
                ...
                R.string.drm_property_analog_output_capabilities to "analogOutputCapabilities",
                R.string.drm_property_can_disable_analog_output to "canDisableAnalogOutput",
